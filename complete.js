    ...
    event.target.closest('.skill-tab').classList.add('active');
            ...
            // Trigger animation for progress bars in the active section
            setTimeout(() => {
                const activeSection = document.getElementById(category + '-skills');
    const progressBars = activeSection.querySelectorAll('.skill-progress-bar');
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Trigger animation for initial visible progress bars
        setTimeout(() => {
            const initialBars = document.querySelectorAll('#technical-skills .skill-progress-bar');
